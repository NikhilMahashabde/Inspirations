...
const Logo = () => {
  return <SiYourtraveldottv size={70} />;
        ...
        <Container as={Stack} maxW={"6xl"} py={10}>
          ...
          >
            <Stack spacing={6}>
              ...
              <Text fontSize={"sm"}>
                © 2023 Inspirations. All rights reserved
              </Text>
              <Stack direction={"row"} spacing={6}>
                <SocialButton
                  label={"Github"}
                  href={"https://github.com/NikhilMahashabde"}
                >
                  <FaGithubSquare />
                </SocialButton>
                <SocialButton
                  label={"Portfolio"}
                  href={"https://nikhilmahashabde.netlify.app/"}
                >
                  <CgWebsite />
                </SocialButton>
                <SocialButton
                  label={"LinkedIn"}
                  href={
                    "https://www.linkedin.com/in/nikhil-mahashabde-5b470236/"
                  }
                >
                  <FaLinkedin />
                </SocialButton>
            ...
            <Stack align={"flex-start"}>
              ...
              <Link href={"https://nikhilmahashabde.netlify.app/"}>
                About The Author
              </Link>
              <Link
                href={"https://www.linkedin.com/in/nikhil-mahashabde-5b470236/"}
              >
                Contact us
              </Link>
            </Stack>
            ...
            <Stack align={"flex-start"}>
              <ListHeader>Have Feedback?</ListHeader>
              <Stack direction={"row"}>
                <IconButton
                  ...
                  onClick={() =>
                    (window.location.href =
                      "mailto:nikhil.mahashabde@gmail.com")
                  }
                />
              </Stack>
            </Stack>
