...
var createNewUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var result, error_1, newUser, error_2;
        ...
        switch (_a.label) {
            case 0:
                if (!(req.body.name &&
                    ...
                    return [2 /*return*/, res.status(400).json({ error: "Data missing from form" })];
            ...
            case 3:
                error_1 = _a.sent();
                res.status(400).json({ error: "".concat(error_1) });
                return [3 /*break*/, 4];
            case 4:
                newUser = {
                    name: req.body.name,
                    email: req.body.email,
                    passwordHash: bcrypt_1.default.hashSync(req.body.password, bcrypt_1.default.genSaltSync()),
                };
                _a.label = 5;
            case 5:
                _a.trys.push([5, 7, , 8]);
            ...
            case 7:
                error_2 = _a.sent();
                res.status(400).json({ message: "Error creating user ".concat(error_2) });
                return [3 /*break*/, 8];
